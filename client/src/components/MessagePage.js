        ...
        <div style={{backgroundImage:`url(${backgroundImage})`}} className='bg-no-repeat bg-cover'>
            ...
            <header className='sticky top-0 h-16 bg-white flex justify-between items-center px-4'>
                <div className='flex items-center gap-4'>
                    ...
                    <div>
                        <h3 className='font-semibold text-lg my-0 text-ellipsis line-clamp-1'>이민상</h3>
            ...
            <section className='h-[calc(100vh-128px)] overflow-x-hidden overflow-y-scroll scrollbar relative bg-slate-200 bg-opacity-50'>
                <div className='flex flex-col gap-2 py-2 mx-2'>
                    <div className={`p-1 py-1 rounded w-fit max-w[280px] md:max-w-sm lg:max-w-wd bg-teal-100`}>
                        <p className='px-2 '> 상대방 대화 답장</p>
                        <p className='text-xs ml-auto w-fit'> 오후 12:42 </p>
                    </div>
                    <div className={`p-1 py-1 rounded w-fit max-w[280px] md:max-w-sm lg:max-w-wd ml-auto bg-yellow-200`}>
